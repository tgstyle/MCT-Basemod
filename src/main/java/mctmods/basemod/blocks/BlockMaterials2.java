...
public class BlockMaterials2 extends BlockBase {
	...
	public BlockMaterials2() {
		super(Material.IRON, MapColor.GRAY, "block_materials2");
	}
	...
	public void getSubBlocks(CreativeTabs tab, NonNullList<ItemStack> list)	{
		for(EnumMaterials2 type : EnumMaterials2.values()) {
	...
	public IBlockState getStateFromMeta(int meta) {
		return getDefaultState().withProperty(VARIANT, EnumMaterials2.values()[meta]);
	}
