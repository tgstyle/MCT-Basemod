...
public class BlockOre2 extends BlockBaseOre {
	private static final PropertyEnum<EnumOre2> VARIANT = PropertyEnum.create("blocks", EnumOre2.class);

	public BlockOre2() { super(Material.ROCK, MapColor.GRAY, "ore2"); }
	...
	@Override @Nonnull public IBlockState getStateFromMeta(int meta) { return getDefaultState().withProperty(VARIANT, EnumOre2.values()[meta]); }
