...
public class BlockOre4 extends BlockBaseOre {
	private static final PropertyEnum<EnumOre4> VARIANT = PropertyEnum.create("blocks", EnumOre4.class);

	public BlockOre4() { super(Material.ROCK, MapColor.GRAY, "ore4"); }
	...
	@Override @Nonnull public IBlockState getStateFromMeta(int meta) { return getDefaultState().withProperty(VARIANT, EnumOre4.values()[meta]); }
	...
	@Override public void getDrops(@Nonnull NonNullList<ItemStack> drops, @Nonnull IBlockAccess world, @Nonnull BlockPos pos, @Nonnull IBlockState state, int fortune) {
		...
		EnumOre4 block = state.getValue(VARIANT);
