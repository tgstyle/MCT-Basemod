...
public class BlockSheetMetal1 extends BlockBase {
	...
	public BlockSheetMetal1() {
		super(Material.IRON, MapColor.GRAY, "sheet_metal1");
	}
	...
	@Override @Nonnull public IBlockState getStateFromMeta(int meta) { return getDefaultState().withProperty(VARIANT, EnumSheetMetal1.values()[meta]); }
