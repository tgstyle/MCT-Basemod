...
public enum EnumOre1 implements IStringSerializable {
	...
	COPPER_ORE		("copper_ore"		, EnumRarity.COMMON, "mctCopper"		, "", 0, 2, 3, 15, 64, Registry.ORE_CRACKED1, 1, 0, null, 1, 0),
	COPPER_DENSE_ORE("copper_dense_ore"	, EnumRarity.COMMON, "mctDenseCopper"	, "", 0, 2, 3, 15, 64, Registry.ORE_CRACKED1, 1, 0, null, 1, 0),
	TIN_POOR_ORE	("tin_poor_ore"		, EnumRarity.COMMON, "mctPoorTin"		, "", 0, 2, 3, 15, 64, Registry.ORE_CRACKED1, 1, 1, null, 1, 0),
	TIN_ORE			("tin_ore"			, EnumRarity.COMMON, "mctTin"			, "", 0, 2, 3, 15, 64, Registry.ORE_CRACKED1, 1, 1, null, 1, 0),
	TIN_DENSE_ORE	("tin_dense_ore"	, EnumRarity.COMMON, "mctDenseTin"		, "", 0, 2, 3, 15, 64, Registry.ORE_CRACKED1, 1, 1, null, 1, 0),
	NICKEL_POOR_ORE	("nickel_poor_ore"	, EnumRarity.COMMON, "mctPoorNickel"	, "", 0, 2, 3, 15, 64, Registry.ORE_CRACKED1, 1, 2, null, 1, 0),
	NICKEL_ORE		("nickel_ore"		, EnumRarity.COMMON, "mctNickel"		, "", 0, 2, 3, 15, 64, Registry.ORE_CRACKED1, 1, 2, null, 1, 0),
	NICKEL_DENSE_ORE("nickel_dense_ore"	, EnumRarity.COMMON, "mctDenseNickel"	, "", 0, 2, 3, 15, 64, Registry.ORE_CRACKED1, 1, 2, null, 1, 0),
	IRON_POOR_ORE	("iron_poor_ore"	, EnumRarity.COMMON, "mctPoorIron"		, "", 0, 1, 3, 15, 64, Registry.ORE_CRACKED1, 1, 3, null, 1, 0),
	IRON_ORE		("iron_ore"			, EnumRarity.COMMON, "mctIron"			, "", 0, 2, 3, 15, 64, Registry.ORE_CRACKED1, 1, 3, null, 1, 0),
	IRON_DENSE_ORE	("iron_dense_ore"	, EnumRarity.COMMON, "mctDenseIron"		, "", 0, 2, 3, 15, 64, Registry.ORE_CRACKED1, 1, 3, null, 1, 0),
	GOLD_POOR_ORE	("gold_poor_ore"	, EnumRarity.COMMON, "mctPoorGold"		, "", 0, 1, 3, 15, 64, Registry.ORE_CRACKED1, 1, 4, null, 1, 0),
	GOLD_ORE		("gold_ore"			, EnumRarity.COMMON, "mctGold"			, "", 0, 2, 3, 15, 64, Registry.ORE_CRACKED1, 1, 4, null, 1, 0),
	GOLD_DENSE_ORE	("gold_dense_ore"	, EnumRarity.COMMON, "mctDenseGold"		, "", 0, 2, 3, 15, 64, Registry.ORE_CRACKED1, 1, 4, null, 1, 0);
