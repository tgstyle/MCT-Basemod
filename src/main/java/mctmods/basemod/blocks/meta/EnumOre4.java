...
public enum EnumOre4 implements IStringSerializable {
	...
	IRIDIUM_ORE		("iridium_ore"		, EnumRarity.EPIC, "mctIridium"		, "", 0, 4, 3, 15, 64, Registry.ORE_CRACKED3, 1, 7, null, 1, 0),
	END_ORE			("end_ore"			, EnumRarity.EPIC, "mctEnd"			, "", 0, 4, 3, 15, 64, Registry.ORE_CRACKED3, 1, 8, null, 1, 0),
	DRACONIUM_ORE	("draconium_ore"	, EnumRarity.EPIC, "mctDraconium"	, "", 0, 4, 4, 15, 64, Registry.ORE_CRACKED3, 1, 9, null, 1, 0);
