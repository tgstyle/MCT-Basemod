...
public class ItemBlockOreCracked3 extends ItemBlockBase {
	...
	public String getUnlocalizedName(ItemStack stack) {
		return super.getUnlocalizedName() + "." + EnumOreCracked3.values()[stack.getMetadata()].getName();
	}

	@Override
	public EnumRarity getRarity(ItemStack stack) {
		return EnumOreCracked3.values()[stack.getMetadata()].getRarity();
	}

	@Override
	public int getItemStackLimit(ItemStack stack) {
		return EnumOreCracked3.values()[stack.getMetadata()].getMaxSize();
	}
